...
const ServiceSection = () => {
  const serviceData = [
    ...
    },
    {
      ...
      description:
        "High quality vertical videos designed specifically for Instagram Reels, YouTube Shorts, and similar formats.",
            ...
            {serviceData.map((service, index) => (
             ...
             >
               <div
                 ...
                 style={{
                   background:
                     `linear-gradient(rgba(32, 32, 32, 0.8), rgba(32, 32, 32, 0.8)), url(${service.bgImg})`,

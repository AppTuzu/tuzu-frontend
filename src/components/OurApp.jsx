...
const OurApp = () => {
  ...
  return (
    <div className="relative border-t border-t-themeBlue/20 flex justify-center items-center py-28 px-14 overflow-hidden" style={{background: 'linear-gradient(180deg, rgba(12,192,223,0.05), rgba(32,32,32,0.05))'}}>

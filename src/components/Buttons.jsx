...
export const Button = () => {
  return (
    <div className="flex items-center text-lg gap-3 w-fit justify-center px-7 py-3 bg-themeYellow rounded-3xl text-themeBlack hover:bg-themeYellow  cursor-pointer transition-all duration-500 font-medium hover:scale-[102%] hover:shadow-lg shadow-themeYellow/30">
      Create with us
      {/* <FaArrowRight /> */}
    </div>
  );

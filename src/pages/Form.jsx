...
const FormPrev = () => {
	...
	// 	// ) {
	// 	// 	return "Please upload video files to continue";
	// 	// }
	// 	setError('')
	// 	return "";
	// };
		...
		<div className="bg-themeBlack pt-32 pb-16 px-4 sm:px-6">
			<div className="max-w-2xl mx-auto">
				<motion.div
					...
					className="bg-white rounded-3xl shadow-lg overflow-hidden p-2"
				>
					{/* Header & progress bar */}
					<div className="px-4 sm:px-8 py-4 sm:py-6 border-b border-gray-100">
						...
						<div className="flex items-center justify-between mb-6 gap-3">
							...
							>
								...
								{steps[currentStep - 1].title === "Checkout" && "Order Summary"}
					...
					<div className="px-4 sm:px-8 py-4 sm:py-6 border-t border-gray-100 flex justify-between">
						...
						<motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
							<Button
								...
								disabled={
									currentStep === steps.length ? false : !canProceedToNextStep()
								}
